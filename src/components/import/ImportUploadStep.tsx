  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <label className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 px-4 py-10 text-center dark:border-gray-700 dark:bg-gray-800/50">
        ...
        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Seleziona file CSV</span>
        <span className="text-xs text-gray-400">Separatore, encoding e formato numerico rilevati automaticamente</span>
        <input
          type="file"
